  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-gray-50">
      <div className="w-full max-w-md mx-auto bg-white rounded-3xl onboarding-card px-6 py-8">
        ...
        {/* No visible divider in the provided design */}
        ...
        {/* Continue button */}
        <button
          className={`w-full py-3.5 px-4 continue-button rounded-full text-white font-medium text-base transition-all ${
